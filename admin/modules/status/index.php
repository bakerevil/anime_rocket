...
<body>
    ...
    <main id="main" class="main">
        ...
        <section id="insert_data">
            <div class="container">
                <form action="consult.php" method="POST" id="form">
                    <div class="row mt-5">
                        <div class="col-6 ">
                            <label for="titulo" class="form-label">Id del status del video</label>
                            <input type="text" class="form-control" name="id" id="id">
                        </div>
                        <div class="col-6 mb-3">
                            <label for="titulo" class="form-label">Status del Video</label>
                            <input type="text" class="form-control" name="statusdelvideo" id="statusdelvideo">
                        </div>
                        <div class="col-12">
